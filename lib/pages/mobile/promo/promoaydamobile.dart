...
class PromoAydaMobile extends StatefulWidget {
  const PromoAydaMobile({super.key});

  @override
  State<PromoAydaMobile> createState() => _PromoAydaMobileState();
}

class _PromoAydaMobileState extends State<PromoAydaMobile> {
