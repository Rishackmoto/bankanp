...
class InformasiKegiatanTablet extends StatefulWidget {
  const InformasiKegiatanTablet({super.key});

  @override
  State<InformasiKegiatanTablet> createState() =>
      _InformasiKegiatanTabletState();
}
