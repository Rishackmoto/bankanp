...
class SimulasiDepositoPageTablet extends StatefulWidget {
  const SimulasiDepositoPageTablet({super.key});

  @override
  State<SimulasiDepositoPageTablet> createState() =>
      _SimulasiDepositoPageTabletState();
}

class _SimulasiDepositoPageTabletState
    extends State<SimulasiDepositoPageTablet> {
