...
import 'package:website/pages/tablet/promo/promoaydatablet.dart';
import 'package:website/pages/tablet/promo/simulasidepositotablet.dart';

class PromoTablet extends StatelessWidget {
  const PromoTablet({super.key});
        ...
        body: const Column(
          children: [
            Expanded(
              child: TabBarView(
                children: [
                  SimulasiDepositoPageTablet(), // tab 1
                  SimulasiKreditPage(), // tab 2
                  PromoAydaTablet(), // tab 3
                ],
              ),
            ),
          ],
