...
class PromoAydaTablet extends StatefulWidget {
  const PromoAydaTablet({super.key});

  @override
  State<PromoAydaTablet> createState() => _PromoAydaTabletState();
}

class _PromoAydaTabletState extends State<PromoAydaTablet> {
