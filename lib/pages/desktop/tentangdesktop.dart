                        ...
                        children: [
                          ...
                          Container(
                            ...
                            child: Table(
                              ...
                              children: [
                                _buildTableRow(
                                    'Komisaris Utama', 'AGUSTHINA THENU'),
                                _buildTableRow('Komisaris', 'JOSINA LAWALATA'),
                                _buildTableRow(
                                    'Direktur Utama', 'VERASISCA NAINGGOLAN'),
                                _buildTableRow('Direktur Operasional',
                                    'TONGGOR MANAHAN NAPITUPULU'),
                                _buildTableRow('Direktur Kepatuhan',
                                    'CAROLINA SUSTIANA SIUS'),
                              ],
                            ),
                          ),
                          const SizedBox(
                          ...
                          Container(
                            ...
                            child: Table(
                              ...
                              children: [
                                _buildTableRow('Pemegang Saham Pengendali',
                                    'LEDRYK J. LEKENILA'),
                                _buildTableRow('Pemegang Saham',
                                    'GKI SINODE DI TANAH PAPUA'),
                                _buildTableRow(
                                    'Pemegang Saham', 'SAKTIANTA DWANGKARA'),
                                _buildTableRow(
