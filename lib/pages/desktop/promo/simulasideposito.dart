...
class SimulasiDepositoPageDesktop extends StatefulWidget {
  const SimulasiDepositoPageDesktop({super.key});

  @override
  State<SimulasiDepositoPageDesktop> createState() =>
      _SimulasiDepositoPageDesktopState();
}

class _SimulasiDepositoPageDesktopState
    extends State<SimulasiDepositoPageDesktop> {
